...
#	endif
	...
	// 64-bit mac
	// ///////////////////////////////////////////////////////////////////////////////
	return "g++ -shared -o " + FixPhysical( tpl ) + ".so -Wl,-undefined,suppress -Wl,-unexported_symbol,_ap_get_client_block";

#elif __linux__
	// ///////////////////////////////////////////////////////////////////////////////
	// 64-bit linux
	// ///////////////////////////////////////////////////////////////////////////////
	return "g++ -shared -Wl,--allow-shlib-undefined -o " + FixPhysical( tpl ) + ".so ";
...
#	endif
	...
	// 64-bit mac
	// ///////////////////////////////////////////////////////////////////////////////
	return "g++ -shared -undefined dynamic_lookup -o " + FixPhysical( tpl ) + ".so ";
...
#	endif
	...
	// 64-bit mac
	// ///////////////////////////////////////////////////////////////////////////////
	return "g++ -shared -o " + FixPhysical( bin ) + outLib + ".so -Wl,-undefined,suppress -Wl,-unexported_symbol,_ap_get_client_block";

#elif __linux__
	// ///////////////////////////////////////////////////////////////////////////////
	// 64-bit linux
	// ///////////////////////////////////////////////////////////////////////////////
	return "g++ -shared -Wl,--allow-shlib-undefined -o " + FixPhysical( bin ) + outLib + ".so ";
